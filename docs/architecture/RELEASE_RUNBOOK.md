...
& $adb -s $env:ANDROID_SERIAL uninstall com.limelight.unofficialA
& $adb -s $env:ANDROID_SERIAL install $candidateApk
& $adb -s $env:ANDROID_SERIAL logcat -c
& $adb -s $env:ANDROID_SERIAL shell am start -W `
    -n com.limelight.unofficialA/com.limelight.PcView
& $adb -s $env:ANDROID_SERIAL shell pidof com.limelight.unofficialA
