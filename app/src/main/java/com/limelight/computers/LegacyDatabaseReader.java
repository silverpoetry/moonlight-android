...
public class LegacyDatabaseReader {
    ...
    private static ComputerDetails getComputerFromCursor(Cursor c) {
        ...
        try {
            ...
            LimeLog.warning("DB: Migrating legacy local host address");
            ...
            if (stringData.startsWith(ADDRESS_PREFIX)) {
                ...
                LimeLog.severe("DB: Corrupted legacy local host address");
            }
        }
        ...
        try {
            ...
            LimeLog.warning("DB: Migrating legacy remote host address");
        } catch (UnknownHostException e) {
            // This is probably a hostname/address with the prefix string
            ...
            if (stringData.startsWith(ADDRESS_PREFIX)) {
                ...
                LimeLog.severe("DB: Corrupted legacy remote host address");
            }
        }
