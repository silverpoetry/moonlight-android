...
public final class AndroidAppPresentationSettingsLoaderTest {
    @Test
    public void freshInstallPersistsDeviceSpecificIconDefault() {
        FakeRepository repository = new FakeRepository();

        AndroidAppPresentationSettingsLoader.prepare(
                repository,
                true);
    ...
    @Test
    public void explicitIconChoiceIsPreserved() {
        FakeRepository repository = new FakeRepository();
